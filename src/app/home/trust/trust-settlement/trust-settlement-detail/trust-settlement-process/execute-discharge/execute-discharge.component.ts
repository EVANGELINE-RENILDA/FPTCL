...
import { entTrustSettlementApplication, entTrustSettlementApplicationDocument, entTrustSettlementApplicationNotes, entTrustSettlementAssignedOfficerHistory, entTrustWithdrawalApplication, entTrustWithdrawalApplicationAssignedOfficerHistory, entTrustWithdrawalApplicationDocument, entTrustWithdrawalApplicationNotes } from '../../../../../../common/api-services/application-api/application-api.classes';
...
import { TrustWithdrawalPipePipe } from '../../../../trust-withdrawal/trust-withdrawal-detail/trust-withdrawal-pipe.pipe';
...
@Component({
  selector: 'app-execute-discharge',
  standalone: true,
  ...
  templateUrl: './execute-discharge.component.html',
  styleUrl: './execute-discharge.component.scss'
})
export class ExecuteDischargeComponent {
  ...
  notesList: any
  saveNotes() {
    this.trustSettlementNotes.trustSettlementApplicationId = this.application.trustSettlementApplicationId;
    this.application.lstentTrustSettlementApplicationNotes = this.trustSettlementNotes;
