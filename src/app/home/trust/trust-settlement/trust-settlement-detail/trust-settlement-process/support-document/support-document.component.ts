...
import { entTrustSettlementApplication, entTrustSettlementAssignedOfficerHistory, entTrustSettlementApplicationDocument, entTrustSettlementApplicationNotes } from '../../../../../../common/api-services/application-api/application-api.classes';
...
// import { TrustSettlementPipePipe } from '../../../../trust-withdrawal/trust-withdrawal-detail/trust-withdrawal-pipe.pipe';
  ...
  async init() {
    ...
    if (this.application.lstentTrustSettlementApplicationNotes.length !== 0) {
      ...
      this.application.lstentTrustSettlementApplicationNotes.forEach((element: any) => {
        if (element.applicationStageValue === 'RECSD' && element.identificationNo === this.type.identificationNo) {
