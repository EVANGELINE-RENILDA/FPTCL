import { Component, CUSTOM_ELEMENTS_SCHEMA, EventEmitter, Input, input, Output, TemplateRef, ViewChild } from '@angular/core';
...
@Component({
  selector: 'app-below-threshold',
  standalone: true,
  imports: [AccordionModule, FormsModule, Row, ViewLabel, InputControlComponent, AppDatePipe, IconButtonComponent, 
    AppTableComponent, CellDefDirective, CellHeaderDefDirective,TrustWithdrawalPipePipe, TabSubComponent,TabSubGroupComponent],
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
  templateUrl: './below-threshold.component.html',
  styleUrl: './below-threshold.component.scss'
})
export class BelowThresholdComponent {
