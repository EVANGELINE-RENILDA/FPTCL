...
@Component({
  selector: 'app-budget-ceiling-search',
  standalone: true,
  ...
  templateUrl: './budget-ceiling-search.component.html',
  styleUrl: './budget-ceiling-search.component.scss'
})
export class BudgetCeilingSearchComponent {
  pageId = 'FUDTN';
  ...
  navigateToDetail() {
    this.router.navigateByUrl('home/budget/configuration/budget-ceiling/detail/')
  }
