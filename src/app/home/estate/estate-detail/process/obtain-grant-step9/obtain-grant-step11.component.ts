...
@Component({
  selector: 'app-obtain-grant-step11',
  standalone: true,
  imports: [AccordionModule, FormsModule, DropZoneComponent, InputControlComponent,
     AppTableComponent, CellDefDirective, CellHeaderDefDirective, FileSizePipe, Row],
  schemas:[CUSTOM_ELEMENTS_SCHEMA],
  templateUrl: './obtain-grant-step11.component.html',
  styleUrl: './obtain-grant-step11.component.scss'
})
export class ObtainGrantStep11Component {
