...
import { CellDefDirective, CellHeaderDefDirective, AppTableComponent } from '../../../../../app-core/template/app-table/app-table.component';
...
@Component({
  selector: 'app-obtain-detail-ins-step3',
  standalone: true,
  imports: [AccordionModule, FormsModule, InputControlComponent, ViewLabel, Row,
    IconButtonComponent, CellDefDirective, CellHeaderDefDirective, AppTableComponent, InnerScroll,
     AppDatePipe, TabSubComponent, TabSubGroupComponent, FileSizePipe, DropZoneComponent],
    schemas: [CUSTOM_ELEMENTS_SCHEMA],
  templateUrl: './obtain-detail-ins-step3.component.html',
  styleUrl: './obtain-detail-ins-step3.component.scss'
})
export class ObtainDetailInsStep3Component {
