...
@Component({
  selector: 'app-real-property-step21',
  standalone: true,
  ...
  templateUrl: './real-property-step21.component.html',
  styleUrl: './real-property-step21.component.scss'
})
export class RealPropertyStep21Component {
