...
@Component({
  selector: 'app-remit-death-step19',
  standalone: true,
  ...
  templateUrl: './remit-death-step19.component.html',
  styleUrl: './remit-death-step19.component.scss'
})
export class RemitDeathStep19Component {
