...
@Component({
  selector: 'app-lodge-application-step12',
  standalone: true,
  imports: [AccordionModule, FormsModule, InputControlComponent, IconButtonComponent, ViewLabel, DropZoneComponent, Row, InnerScroll, TabSubComponent, TabSubGroupComponent, FileSizePipe, AppDatePipe],
  schemas:[CUSTOM_ELEMENTS_SCHEMA],
  templateUrl: './lodge-application-step12.component.html',
  styleUrl: './lodge-application-step12.component.scss'
})
export class LodgeApplicationStep12Component {
