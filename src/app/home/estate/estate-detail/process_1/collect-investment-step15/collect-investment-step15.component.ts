...
@Component({
  selector: 'app-collect-investment-step15',
  standalone: true,
  ...
  templateUrl: './collect-investment-step15.component.html',
  styleUrl: './collect-investment-step15.component.scss'
})
export class CollectInvestmentStep15Component {
