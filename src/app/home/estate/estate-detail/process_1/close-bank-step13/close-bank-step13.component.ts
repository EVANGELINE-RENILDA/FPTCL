...
@Component({
  selector: 'app-close-bank-step13',
  standalone: true,
  ...
  templateUrl: './close-bank-step13.component.html',
  styleUrl: './close-bank-step13.component.scss'
})
export class CloseBankStep13Component {
