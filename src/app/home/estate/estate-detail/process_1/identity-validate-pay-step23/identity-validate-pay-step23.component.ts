...
@Component({
  selector: 'app-identity-validate-pay-step23',
  standalone: true,
  ...
  templateUrl: './identity-validate-pay-step23.component.html',
  styleUrl: './identity-validate-pay-step23.component.scss'
})
export class IdentityValidatePayStep23Component {
