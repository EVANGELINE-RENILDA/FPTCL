...
@Component({
  selector: 'app-create-authority-step8',
  standalone: true,
  ...
  templateUrl: './create-authority-step8.component.html',
  styleUrl: './create-authority-step8.component.scss'
})
export class CreateAuthorityStep8Component {
