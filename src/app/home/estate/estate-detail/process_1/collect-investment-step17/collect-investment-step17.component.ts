...
@Component({
  selector: 'app-collect-investment-step17',
  standalone: true,
  ...
  templateUrl: './collect-investment-step17.component.html',
  styleUrl: './collect-investment-step17.component.scss'
})
export class CollectInvestmentStep17Component {
