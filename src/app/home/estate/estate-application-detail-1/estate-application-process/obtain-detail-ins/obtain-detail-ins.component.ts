...
@Component({
  selector: 'app-obtain-detail-ins',
  standalone: true,
  imports: [Row, InputControlComponent, FormsModule, ViewLabel, IconButtonComponent, AccordionModule, AppDatePipe, AppTableComponent, CellDefDirective, CellHeaderDefDirective, EstateApplicationPipe, FileSizePipe, DropZoneComponent, TabSubComponent, TabSubGroupComponent],
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
  templateUrl: './obtain-detail-ins.component.html',
  styleUrl: './obtain-detail-ins.component.scss'
})
export class ObtainDetailInsComponent {
