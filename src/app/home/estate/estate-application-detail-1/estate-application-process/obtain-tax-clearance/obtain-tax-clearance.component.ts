...
@Component({
  selector: 'app-obtain-tax-clearance',
  standalone: true,
  ...
  templateUrl: './obtain-tax-clearance.component.html',
  styleUrl: './obtain-tax-clearance.component.scss'
})
export class ObtainTaxClearanceComponent {
