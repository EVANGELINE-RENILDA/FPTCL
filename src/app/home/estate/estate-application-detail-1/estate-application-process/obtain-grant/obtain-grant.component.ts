...
@Component({
  selector: 'app-obtain-grant',
  standalone: true,
  imports: [AccordionModule, FormsModule, InputControlComponent, FormsModule, ViewLabel, Row, IconButtonComponent, AppTableComponent, EstateApplicationPipe, FileSizePipe, DropZoneComponent],
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
  templateUrl: './obtain-grant.component.html',
  styleUrl: './obtain-grant.component.scss'
})
export class ObtainGrantComponent {
