...
@Component({
  selector: 'app-item-wise-sales-report-detail',
  standalone: true,
  ...
  templateUrl: './item-wise-sales-report-detail.component.html',
  styleUrl: './item-wise-sales-report-detail.component.scss',
  schemas:[CUSTOM_ELEMENTS_SCHEMA]
})
export class ItemWiseSalesReportDetailComponent {
  ...
  columns: any = ["date", "doc", "name", "qty","value"];
  columnsName: any = ["Doc Date", "Doc #", "Voucher Name", "QTY","Value"];
