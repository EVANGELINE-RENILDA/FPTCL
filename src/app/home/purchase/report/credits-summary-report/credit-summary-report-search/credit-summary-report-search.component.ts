...
@Component({
  selector: 'app-credit-summary-report-search',
  standalone: true,
  imports: [
    IconButtonComponent,
    AppTableComponent,
  ...
  templateUrl: './credit-summary-report-search.component.html',
  styleUrl: './credit-summary-report-search.component.scss',
})
export class CreditSummaryReportSearchComponent {
  __selectedItems: any;
  currentDate = '';
  ...
  generateCreditorsSummaryReportAsExcel() {
    ...
    this.api.generateCreditorsSummaryReportExcel(this.purchaseReport).subscribe((success) => {
  ...
  async creditorDetail(vendorId: any) {
    ...
    this.router.navigateByUrl(
      '/home/purchase/report/credit-summary-report/detail/' + urlJson
    );
  }
