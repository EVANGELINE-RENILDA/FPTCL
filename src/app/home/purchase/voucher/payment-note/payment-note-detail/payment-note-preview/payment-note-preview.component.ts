...
import { entGetMailInfo, entPurPaymentNote } from '../../../../../../common/api-services/accounts-api/accounts-api.classes';
...
@Component({
  selector: 'app-payment-note-preview',
  standalone: true,
  schemas: [CUSTOM_ELEMENTS_SCHEMA],

  imports: [InputControlComponent, FormsModule, IconButtonComponent, Row,AppSafePipe,InnerScroll,AppAccessDirective, ButtonAccessDirective,CheckboxComponent,DropZoneComponent],
  templateUrl: './payment-note-preview.component.html',
  styleUrl: './payment-note-preview.component.scss'
})
export class PaymentNotePreviewComponent {
...
base64String: any = '';
attachmentList: any = [];
  @Input() parentData = new entPurPaymentNote();
  ...
  viewPurPaymentNoteReceipt() {
    if (this.parentData.purPaymentNoteId !== 0) {
      const obj = {
        data: this.parentData.purPaymentNoteId,
