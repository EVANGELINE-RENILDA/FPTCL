...
import {
  ...
  entPurPurchaseInvoiceStatusHistory,
  entPurPurchaseOrder,
...
@Component({
  selector: 'app-purchase-invoice-status',
  standalone: true,
  ...
  templateUrl: './purchase-invoice-status.component.html',
  styleUrl: './purchase-invoice-status.component.scss'
})
export class PurchaseInvoiceStatusComponent {
  pageId = 'PUISC';
  accountsOption = {
    type: 'accountsPath',
  };
  ...
  searchParams = new entPurPurchaseInvoiceStatusHistory();
  ...
  pageChanged(event: any) {
    ...
    this.searchParams.purPurchaseInvoiceId = this.parentData.purPurchaseInvoiceId;
  ...
  searchPurchaseOrderVoucherStatusHistory() {
    this.accountsService
      ...
      .subscribe((success) => {
        this.parentData.plistentPurPurchaseInvoiceStatusHistory =
          success;
  ...
  savePurPurchaseOrderVoucherStatus() {
    if (
      this.parentData.statusValue !== this.parentData.statusValue
    ) {
      this.accountsService
        ...
        .subscribe((success) => {
          ...
          this.totalCount =
            success.plistentPurPurchaseInvoiceStatusHistory.totalCount;
        });
    }
  }
}
