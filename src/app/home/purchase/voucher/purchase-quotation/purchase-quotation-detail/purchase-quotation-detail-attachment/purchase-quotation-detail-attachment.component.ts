...
@Component({
  selector: 'app-purchase-quotation-detail-attachment',
  standalone: true,
  ...
  templateUrl: './purchase-quotation-detail-attachment.component.html',
  styleUrl: './purchase-quotation-detail-attachment.component.scss'
})
export class PurchaseQuotationDetailAttachmentComponent {

  filterFileName = '';
  @Input() parentData: any;
  @Output() attachmentData = new EventEmitter();

  purchaseQuotationAttachments = new entPurAttachments();
  ...
  async uploadAttachemnt(event: any) {
    this.purchaseQuotationAttachments.referenceId = this.parentData.purQuotationId;
