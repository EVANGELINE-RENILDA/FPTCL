...
@Component({
  selector: 'app-service-in-process1',
  standalone: true,
  imports: [AccordionModule, ViewLabel, InputControlComponent, FormsModule, IconButtonComponent, Row, FileSizePipe, AppDatePipe, AppTableComponent, DropZoneComponent, TabSubGroupComponent, TabSubComponent],
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
  templateUrl: './service-in-process1.component.html',
  styleUrl: './service-in-process1.component.scss'
})
export class ServiceInProcess1Component {
  ...
  async init() {
    ...
    this.documentTypeDDLdata();this.loading  = true
