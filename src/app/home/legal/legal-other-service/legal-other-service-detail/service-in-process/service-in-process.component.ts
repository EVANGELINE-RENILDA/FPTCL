...
@Component({
  selector: 'app-service-in-process',
  standalone: true,
  templateUrl: './service-in-process.component.html',
  styleUrl: './service-in-process.component.scss',
  imports: [AccordionModule, ViewLabel, InputControlComponent, FormsModule, IconButtonComponent, Row, FileSizePipe, AppDatePipe, AppTableComponent, DropZoneComponent, TabSubComponent, TabSubGroupComponent],
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
})
export class ServiceInProcessComponent {
