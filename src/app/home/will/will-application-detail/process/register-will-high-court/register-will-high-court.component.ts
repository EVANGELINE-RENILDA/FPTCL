...
@Component({
  selector: 'app-register-will-high-court',
  standalone: true,
  imports: [
    AccordionModule,
    FormsModule,
  ...
  templateUrl: './register-will-high-court.component.html',
  styleUrl: './register-will-high-court.component.scss',
})
export class RegisterWillHighCourtComponent {
  ...
  init() {
    ...
    if (this.application.lstentWillApplicationNotes.length !== 0) {
      this.application.lstentWillApplicationNotes.forEach((element: any) => {
        if (
          element.applicationStageValue === 'REHIC' &&
