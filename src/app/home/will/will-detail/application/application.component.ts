...
export class ApplicationComponent {
  @Input() application = new entWill();
  @Output() applicationChange = new EventEmitter<any>();
  cardAccordionContent = 1;
  accordionOpen = true;
  currentDate: any;
  errorTrue = false;
  willSpouse = this.application.ientWillSpouse;
  willSpouseRAW =this.application.ientWillSpouse;
  willChildren = new entWillApplicationChildren();
  willChildrenRAW = new entWillApplicationChildren();
  // application.ientWillTestator = this.application.ientWillTestator;
  // willTestatorRAW = this.application.ientWillTestator;
  willRealEstate = this.application.ientWillRealestateDetails;
  willRealEstateRAW = this.application.ientWillRealestateDetails;
  willBankFinance = this.application.ientWillFinanceDetails;
  willBankFinanceRAW =this.application.ientWillFinanceDetails;
  willInvestment = this.application.ientWillInvestmentDetails;
  willInvestmentRAW = this.application.ientWillInvestmentDetails;
  willInsurance = this.application.ientWillInsuranceDetails;
  willInsuranceRAW = this.application.ientWillInsuranceDetails;
  willVehicle = this.application.ientWillVehicleDetails;
  willVehicleRAW = this.application.ientWillVehicleDetails;
  ...
  cardTabChange(val: any) {
    ...
    const obj = {
      data: this.application.willId,
    };
    if (val === 1) {
      if (this.application.ientWillApplicant.willApplicantId === 0) {
  ...
  openCustomer(val: any, type: any) {
    ...
    this.apiService.openCustomer(obj).subscribe((success) => {
      if (type === 'applicant') {
        this.application.ientWillApplicant.ientCustomer = success;
      }
      if (type === 'spouse') {
      ...
      if (type === 'testator') {
        this.application.ientWillTestator.ientCustomer = success;
      }
      // if (this.type === 'spouse') {
      //   this.willSpouse.ientCustomer = success;
      // }
  ...
  openCustomerInSearch(val: any, type: any) {
    ...
    this.apiService.openCustomer(obj).subscribe((success) => {
      if (type === 'applicant') {
        this.application.ientWillApplicant.ientCustomer = success;
        this.application.ientWillApplicant.customerId = success.customerId
      }
      if (type === 'spouse') {
        this.willSpouse.ientCustomer = success;
      ...
      if (type === 'testator') {
        this.application.ientWillTestator.ientCustomer = success;
        this.application.ientWillTestator.customerId = success.customerId
      }
      // if (this.type === 'spouse') {
      //   this.willSpouse.ientCustomer = success;
      // }
  ...
  createWillApplicant() {
    this.apiService.createNewWillApplicationApplicant().subscribe((success) => {
      this.application.ientWillApplicant = success;
    });
  }
  ...
  saveApplicant() {
    if (this.aForm.valid) {
      this.application.ientWillApplicant.willApplicantId =
        this.application.willId;
      this.apiService
        .saveWillApplicationApplicant(this.application.ientWillApplicant)
        .subscribe((success) => {
          this.application.ientWillApplicant = success;
  ...
  saveSpouse() {
    if (this.bForm.valid) {
      this.willSpouse.willId = this.application.willId;
      this.apiService
  ...
  refreshSpouse() {
    const obj = {
      data: this.willSpouse.willSpouseId,
    };
    this.apiService.openWillApplictionSpouse(obj).subscribe((success) => {
      this.willSpouse = success;
  ...
  saveChildren() {
    if (this.cForm.valid) {
      this.willChildren.willApplicationId = this.application.willId;
      this.apiService
  ...
  createWillTestator() {
    this.apiService.createWillApplicationTestator().subscribe((success) => {
      this.application.ientWillTestator = success;
    });
  }
  ...
  saveTestator() {
    if (this.dForm.valid) {
      this.application.ientWillTestator.willId = this.application.willId;
      this.apiService
        .saveWillApplicationTestator(this.application.ientWillTestator)
        .subscribe((success) => {
          this.application.ientWillTestator = success;
          this.data.showErrorMessage = false;
          this.dialog.closeAll();
  ...
  refreshRealEstate() {
    const obj = {
      data: this.willRealEstate.willRealestateDetailId,
    };
    this.apiService
      .openWillApplictionRealestateDetails(obj)
      .subscribe((success) => {
  ...
  refreshFinance() {
    const obj = {
      data: this.willBankFinance.willFinanceDetailId,
    };
    this.apiService
      .openWillApplictionFinanceDetails(obj)
      .subscribe((success) => {
  ...
  refreshInvestment() {
    const obj = {
      data: this.willInvestment.willInvestmentDetailId,
    };
    this.apiService
      .openWillApplicationInvestmentDetails(obj)
      .subscribe((success) => {
  ...
  saveInsurance() {
    if (this.hForm.valid) {
      this.willInsurance.willId = this.application.willId;
      this.apiService
  ...
  refreshInsurance() {
    const obj = {
      data: this.willInsurance.willInsuranceDetailId,
    };
    this.apiService
      .openWillApplicationInsuranceDetails(obj)
      .subscribe((success) => {
  ...
  saveVehicle() {
    if (this.iForm.valid) {
      this.willVehicle.willId = this.application.willId;
      this.apiService
  ...
  refreshVehicle() {
    const obj = {
      data: this.willVehicle.willVehicleDetailId,
    };
    this.apiService
      .openWillApplictionVehicleDetails(obj)
      .subscribe((success) => {
  ...
  saveOtherAssets() {
    // this.application.ientWillApplicationOtherAssetDetails.willId =
    //   this.application.willId;
    // if (this.zForm.valid) {
    //   this.apiService
  ...
  otherAssetColumn = ['value', 'description'];
  otherAssetColumnName = ['Value', 'Description'];
