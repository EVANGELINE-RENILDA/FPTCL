...
import { entOrganizationApplication, entOrganizationApplicationAssignedOfficerHistory, entOrganizationApplicationBankDetail, entOrganizationApplicationContactPerson, entOrganizationApplicationDocument, entOrganizationApplicationNotes } from '../../../../common/api-services/application-api/application-api.classes';
...
export class OrganizationChangeDetailComponent {
  ...
  async init() {
    ...
    this.appService.helpFile ='Organization%20Change%20In%20Detail.pdf'
  ...
  onTabChange(event: any) {
    switch (event.tabTitle) {
      case 'Upload Document': this.getDocumentList();
        break;
      case 'History': this.getNotesList();
  ...
  navigateToList() {
    this.router.navigateByUrl('home/organization/organization-change/search')
  }
